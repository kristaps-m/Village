...
export default function Home() {
  ...
  async function registerUser(){
    ...
    const rD = {username: registerUserName,
    ...
    const response = await axios.post(
      "https://localhost:8080/api/Auth/register",regData
      // {
      //   headers: {
  ...
  async function loginUser(){
    ...
    const rD = {username: loginUserName,
    ...
    console.log(regData);
    const response = await axios.post(
      "https://localhost:8080/api/Auth/login",rD
      // {
      //   headers: {
      //     Authorization: `Bearer ${token}`,
      //   },
  ...
  return (
    <main>
      ...
      <br />
      <button onClick={() => console.log(localStorage)}>clg logalStorage</button>
      <br /><br /><br /><br />
